...
- **Other Ideas I Explored**  
  - Interactive Map (Folium) with Marker Clustering – Effective when zoomed in,  
    but one descriptor dominated at lower zoom levels.  
  - Grouping Complaints by Location – Reduced overlap but lost individual report  
    granularity.
